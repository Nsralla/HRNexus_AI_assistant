...
#     """
#     # import os
#     # json_dir = os.path.join(os.path.dirname(__file__), "sources\\Json_files")
#     # kb_dir = os.path.join(os.path.dirname(__file__), "sources\\kb")

#     # print("[DEBUG] JSON Directory:", json_dir)
#     # print("[DEBUG] KB Directory:", kb_dir)
#     # # Initialize loader
#     # loader = RAGDataLoader(
#     #     json_dir=json_dir,
#     #     kb_dir=kb_dir,
...
#     # if vectorstore:
#     # sinve vectorstore already exists from previous runs, we can load it directly
#     json_dir = "./sources/Json_files"
#     kb_dir = "./sources/kb"
#     vectorstore = chroma
