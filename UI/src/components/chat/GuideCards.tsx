  ...
  const cards: GuideCard[] = [
    {
      ...
      description: 'Search employee information, find team members, check skills, and view capacity across Backend, Frontend, DevOps teams.',
      prompts: [
        'Show me all Backend team members',
        'Who has Python skills?',
        'What is Ahmed Ali working on?',
      ],
    },
    {
      id: 'projects',
      ...
      description: 'Track project progress, sprint status, JIRA tickets, and team velocity.',
      prompts: [
        'What is the status of Sprint 24?',
        'Show me open JIRA tickets',
        'What projects is the Backend team working on?',
      ],
    },
    {
      id: 'services',
      icon: <FileText className="w-8 h-8 text-primary" />,
      title: 'Services & Deployments',
      description: 'Check microservice status, deployment history, and uptime metrics.',
      prompts: [
        'Show me recent deployments',
        'What services does Ahmed maintain?',
        'Which services have uptime below 99%?',
      ],
    },
    {
      id: 'documentation',
      icon: <Sparkles className="w-8 h-8 text-primary" />,
      title: 'Meetings & Policies',
      description: 'Access meeting notes, action items, and company policies including code review, escalation, and onboarding guides.',
      prompts: [
        'What is the code review policy?',
        'Show me sprint planning meetings',
